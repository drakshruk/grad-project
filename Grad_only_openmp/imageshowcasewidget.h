...
public:
    ...
    /**
     * EN: Gets the current image as QImage
     * RU: Poluchayet tekushcheye izobrazheniye kak QImage
     */
    QImage getQImage() const { return m_pixmap.toImage(); }

    /**
     * EN: Checks if an image is loaded
     * RU: Proveryayet, zagruzheno li izobrazheniye
     */
    bool hasImage() const { return !m_pixmap.isNull(); }

    /**
     * EN: Gets the current zoom/scale factor
     * RU: Poluchayet tekushchiy faktor masshtabirovaniya
     */
