...
double ImageShowcaseWidget::getScaleFactor() const
{
    if (m_pixmap.isNull() || m_imageRect.isEmpty()) return 1.0;
    return static_cast<double>(m_imageRect.width()) / m_pixmap.width();
}
